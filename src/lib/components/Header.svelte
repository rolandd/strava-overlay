...
<header class="w-full max-w-4xl mx-auto flex items-center justify-between px-4 py-3 bg-[#121216]/80 backdrop-blur-md border-b border-[#27272f]/60 sticky top-0 z-30">
	<!-- Logo & App Title -->
	<div class="flex items-center gap-2.5">
		<div class="w-9 h-9 rounded-xl bg-gradient-to-tr from-[#fc4c02] to-[#ff7a3d] flex items-center justify-center shadow-lg shadow-[#fc4c02]/25 text-white">
			<Flame class="w-5 h-5 fill-white stroke-none" />
		</div>
		<div>
			<div class="flex items-center gap-2">
				<h1 class="text-base font-bold tracking-tight text-white leading-none">
					Ride Overlay
				</h1>
				<span class="text-[10px] font-semibold tracking-wider uppercase px-1.5 py-0.5 rounded bg-[#fc4c02]/15 text-[#fc4c02] border border-[#fc4c02]/30">
					PWA
				</span>
			</div>
