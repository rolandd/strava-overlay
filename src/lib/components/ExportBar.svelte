<script lang="ts">
  import { Share2, Download, Loader2, Trash2 } from '@lucide/svelte';
...
<div
  class="w-full max-w-4xl mx-auto px-4 py-3 sticky bottom-0 z-30 bg-[#09090b]/90 backdrop-blur-lg border-t border-[#27272f]/80"
>
